...
export const AddNewLedgerRecord = ({type, isOpen, setIsOpen}) => {
    ...
    if (type === 'INCOME') {
        return (
            <Modal title="Dodaj wpływ" isOpen={isOpen} setIsOpen={setIsOpen} onSubmit={handleSubmit(onSubmit)}>
    ...
    if (type === 'EXPENSE') {
        return (
            <Modal title="Dodaj wydatek" isOpen={isOpen} setIsOpen={setIsOpen} onSubmit={handleSubmit(onSubmit)}>
        ...
        <FormControl fullWidth>
            ...
            {withSelect ?
                <Controller
                    control={control}
                    name={"category"}
                    render={({field: {onChange, value}}) => (<SelectField onChange={onChange} value={value}/>)}/>
                :
                <></>}
        </FormControl>
    )
...
export const SelectField = ({onChange, value}) => {
    ...
    return (
        ...
        <Select label="Wybierz kategorię" fullWidth onChange={onChange} value={value}>
